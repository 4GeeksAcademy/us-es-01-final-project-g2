      ...
      <div className="container bg-dark text-light p-4 rounded shadow-lg" style={{ maxWidth: '1200px' }}>
        <div className="row">
          ...
          <div className="col-md-4 d-flex flex-column align-items-center">
            <img
              src="https://i.ibb.co/89vJb4f/Dise-o-sin-t-tulo-16.png" // Reemplaza esta URL con la URL de tu imagen
              alt="Perfil"
            ...
            <div className="mt-4 w-100">
              ...
              <div className="d-flex">
                <img src="https://i.ibb.co/gJ1zfJW/Dise-o-sin-t-tulo-9.png" alt="Achievement 1" className="rounded-circle mr-2" />
                <img src="https://i.ibb.co/zSqjNPD/Dise-o-sin-t-tulo-10.png" alt="Achievement 2" className="rounded-circle" />
              </div>
            </div>
          </div>
