      ...
      <div className="container bg-dark text-light p-4 rounded shadow-lg" style={{ maxWidth: '1200px' }}>
        <div className="row">
          ...
          <div className="col-md-4 d-flex flex-column align-items-center">
            <img
              src="https://i.ibb.co/q5YvtMM/Dise-o-sin-t-tulo-12.png" // Reemplaza esta URL con la URL de tu imagen
              alt="Perfil"
              className="rounded-circle border border-secondary mb-3"
              style={{ width: '150px', height: '150px' }}
            />
            <h3>Hector Chocobar-Terrojon</h3>
            ...
            <div className="mt-4 w-100">
              ...
              <div className="d-flex">
                <img src="https://i.ibb.co/1nPC9D4/Dise-o-sin-t-tulo-8.png" alt="Achievement 1" className="rounded-circle mr-2" />
